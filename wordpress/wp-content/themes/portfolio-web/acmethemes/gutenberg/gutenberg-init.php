...
function portfolio_web_dynamic_editor_styles(){
	...
	if( isset($portfolio_web_customizer_all_values['portfolio-web-link-color'])){
	...
	if( isset($portfolio_web_customizer_all_values['portfolio-web-link-hover-color'] )){
...
function portfolio_web_block_editor_styles() {
	...
	wp_enqueue_style( 'portfolio-web-block-editor-styles', get_template_directory_uri() . '/acmethemes/gutenberg/gutenberg-edit.css', false, '1.0' );

	/**
	 * Styles from the customizer
	 */
	wp_add_inline_style( 'portfolio-web-block-editor-styles', portfolio_web_dynamic_editor_styles() );
}
add_action( 'enqueue_block_editor_assets', 'portfolio_web_block_editor_styles',99 );

function portfolio_web_gutenberg_scripts() {
	wp_enqueue_style( 'portfolio-web-block-front-styles', get_template_directory_uri() . '/acmethemes/gutenberg/gutenberg-front.css', false, '1.0' );
	wp_style_add_data( 'portfolio-web-block-front-styles', 'rtl', 'replace' );
}
